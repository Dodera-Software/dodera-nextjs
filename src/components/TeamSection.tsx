    ...
    return (
        <section aria-labelledby="team-heading" className="relative py-24">
            <div className="mx-auto max-w-4xl px-6 text-center">
                ...
                >
                    We started in <span className="font-semibold text-foreground">2023</span> as a team of dedicated, enthusiastic software engineers - and that energy never left. Today our crew covers every layer of a product, with most members carrying{" "}
