 ...
 * src/config/copy.ts
 *
 * All editable page and section copy in one place.
 * Change text here — components pick it up automatically.
 * No need to dig into individual component files.
 */
...
/** Hero section — the big headline & intro on the homepage. */
export const HERO = {
...
/** CTA section — the contact form area with the big headline. */
export const CTA = {
...
/** About page — "Who We Are" story section. */
...
/** About page — value pillars used in the story section. */
...
/** About page — mid-page CTA (above engagement models). */
...
/** About page — bottom CTA (contact form). */
...
/** About page — capability cards ("What We Build" section). */
