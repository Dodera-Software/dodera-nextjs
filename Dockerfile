...
# MOCKUPS_DOMAIN: next.config.ts excludes the mockup preview hosts from the
# site-wide security headers, and `headers()` is evaluated at build time.
ARG MOCKUPS_DOMAIN
